 ...
 */
public class Schwefel_2_22 implements Problem {
    ...
    public Schwefel_2_22() {
        this.nVars = 30;
        nObj = 1;
        name = "Schwefel_2_22_Function";
    ...
    public void costFunction(Individual ind) {
        ...
        for(int i=0; i<ind.getPosition().length; i++) {
            sum += Math.abs(ind.getPosition()[i]);
            prod *= Math.abs(ind.getPosition()[i]);
        }
