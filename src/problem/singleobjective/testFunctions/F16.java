 ...
 */
public class F16 implements Problem {
    ...
    public void costFunction(Individual ind) {
        ...
        f[0] = (4 * Math.pow(ind.getPosition()[0], 2)) 
                - (2.1 * Math.pow(ind.getPosition()[0], 4)) 
                + (Math.pow(ind.getPosition()[0], 6)/3) 
                + (ind.getPosition()[0] * ind.getPosition()[1]) 
                - (4 * Math.pow(ind.getPosition()[1], 2)) 
                + (4 * Math.pow(ind.getPosition()[1], 4));
